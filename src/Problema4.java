...
public class Problema4 {
    ...
    Problema4(){
        ...
        m= new Point2D(Integer.parseInt(JOptionPane.showInputDialog("X[m]=")),(Integer.parseInt(JOptionPane.showInputDialog("Y[m]="))));
    }
    //additions
    ...
    private void centruDeGreutate(Point2D a,Point2D b,Point2D c,int xs,int ys){
        a.setX(a.getX()-xs);a.setY(a.getY()-ys);
        b.setX(b.getX()-xs);b.setY(b.getY()-ys);
        c.setX(c.getX()-xs);c.setY(c.getY()-ys);
    }
    ...
    public String puncteToString(){
        char c='A';
        String s= 'A'+puncte[0].toStringPunct()+" ";c++;
    ...
    public void rezSolutie(){
        ...
        if(i==puncte.length){
            ...
            else JOptionPane.showMessageDialog(null,"M se afla pe frontiera");
